...
public class Enemy_Saucer1 : Monster {

	public GameObject saucer1Parent;
	...
	void UpdateAnimation() {
		saucer1Parent.transform.Rotate(Vector3.forward, 4.5f);	// rotate constantly
		...
		saucer1Parent.transform.localScale += new Vector3(newScale, newScale, 0);
	}
	...
	void UpdateMovement() {
		...
		if (Main.isPlayerAlive) {
			saucer1Parent.transform.position = Vector3.MoveTowards(saucer1Parent.transform.position, Main.player1.transform.position, moveVel);
		}
	}
